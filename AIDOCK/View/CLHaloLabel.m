...
- (void)defaultInit
{
    ...
    _animationPacing = kCAMediaTimingFunctionLinear;
    
    // 设置渐变层参数
    CAGradientLayer *gradientLayer = (CAGradientLayer *)self.layer;
    gradientLayer.backgroundColor  = [super.textColor CGColor];
    gradientLayer.startPoint       = CGPointMake(-_haloWidth / 2, 0);
...
- (void)startAnimating
{
    ...
    if([gradientLayer animationForKey:kAnimationKey] == nil)
    {
        ...
        endPointAnimation.toValue = [NSValue valueWithCGPoint:CGPointMake(1.0 + _haloWidth / 2, 0)];
